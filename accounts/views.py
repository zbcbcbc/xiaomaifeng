...
class RegistrationBaseView(_RequestPassingFormView):
    """
...
class ActivationBaseView(TemplateView):
    """
...
class DeActivationBaseView(RedirectView):
    """
    Base class for user deletion
    """
    ...
    def dispatch(self, *args, **kwargs):
        return super(DeActivationBaseView, self).dispatch(*args, **kwargs)
